...
const breakPoints = [
  ...
  { width: 850, itemsToShow: 3 ,itemPadding:[0,2],pagination: false},
    ...
    return<>
       <div className="Slider my-20">
          ...
          <button onClick={prev}><span class="material-icons-outlined">
            ...
            <Carousel breakPoints={breakPoints} autoPlaySpeed={2000} ref={carousel} outerSpacing={100}>
              {
                arr.map((v,i)=>{
                    return<img key={i} alt="deals" src={arr[i]} className="w-96 h-44 object-fill rounded-md"/>
                })
              }
            </Carousel>
